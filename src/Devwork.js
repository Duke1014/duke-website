        ...
        <div className={`project-card ${cardFocus === 'dod' ? 'expanded-card':''}`} id='doors-of-divergence' onClick={() => openCard('dod')}>
            ...
            {cardFocus === 'dod' ? <>
                <div className='project-card-info'>
                    <a href='https://doorsofdivergence.com' target="_blank" rel="noopener noreferrer">
                    ...
                    <div className='project-card-info-bottom'>
                        ...
                        <p><a href='https://github.com/Duke1014/DoorsOfDivergence' target='_blank' rel='noopener noreferrer'>Github</a></p>
                    </div>
                </div>
            </> : <></>}
        </div>
